...
# Briques « cercle privé » (S182 agenda, S184 ecoute, S185 mail) : le Cœur forwarde
# l'identité de l'utilisateur connecté en X-User-Id, gagée par {BRIQUE}_KEY (seul le Cœur
# la détient). Les autres briques ignorent cet en-tête (motif tenant/bundle-client, cf.
# X-Compte-Id).
