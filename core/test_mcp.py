...
def test_tools_call_action_confirmee_bypasse_le_registre_accord():
    ...
    demandes_avant = dict(accord_action.REGISTRE._demandes)
    capte = {}
    ...
    # Le registre est identique avant/après, quelle que soit la clé : cet appel MCP ne l'a
    # touché sous AUCUNE forme (ni création, ni mutation d'une entrée existante).
    assert accord_action.REGISTRE._demandes == demandes_avant
