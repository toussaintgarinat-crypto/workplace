...
const TYPES = [
  { id: 'filiale',     label: 'Commune membre',    color: 'var(--or-500)', desc: 'A possède B' },
  { id: 'partenaire',  label: 'Partenaire',         color: 'var(--vert)', desc: 'Collaboration' },
  ...
  { id: 'association', label: 'EPCI / Groupement',  color: 'var(--rouge)', desc: 'Lien associatif' },
]
