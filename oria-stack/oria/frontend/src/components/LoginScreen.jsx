      ...
      <div className="login-card">
        ...
        {onglet === '2fa' ? (
          <form onSubmit={verifier2fa}>
            <p style={{ fontSize: 13, color: 'var(--text)', marginBottom: 12, textAlign: 'center' }}>
              {t('login.twoFaTitle')}
            </p>
            <input
              className="input-nom"
            ...
            <button type="button" style={{ background: 'none', border: 'none', color: 'var(--text-mut)', fontSize: 12, cursor: 'pointer', marginTop: 8, width: '100%' }}
