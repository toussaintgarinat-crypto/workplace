  ...
  if (accesPaye === null) {
    return (
      <div className="room-view" style={{ display: 'flex', alignItems: 'center',
                                          justifyContent: 'center', color: 'var(--text-mut)' }}>
  ...
  if (accesPaye === false) {
    ...
    return (
      <div className="room-view" style={{ display: 'flex', alignItems: 'center',
        ...
        <div style={{
          background: 'var(--ink-850)', borderRadius: 16, padding: '40px 48px',
          ...
          <button
            ...
            style={{
              ...
              background: 'var(--or-500)', color: 'white', fontSize: 15,
          ...
          <div style={{ marginTop: 16 }}>
            <button onClick={onQuitter}
              style={{ background: 'none', border: 'none', color: 'var(--text-mut)',
